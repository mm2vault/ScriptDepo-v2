...
@media(max-width:720px){.script-detail-layout{grid-template-columns:1fr;gap:16px}.script-detail-image{height:210px}.script-detail-title{font-size:23px}.script-detail-stats{grid-template-columns:repeat(2,1fr)}.unlock-method-grid{grid-template-columns:1fr}.script-detail-mini-info{grid-template-columns:repeat(3,1fr)}}
"""
